...
const findMaxButton = document.querySelector(".findMax-button");
...
class BinarySearchTree {
  ...
  findMinNodeifInvert(node) {
    if (node.right === null) {
      ...
      return this.findMinNodeifInvert(node.right);
    }
  }
  ...
  searchifinvert(node, data) {
    ...
    // move left
      ...
      traverseTime = traverseTime + traverseTimeChange;
      return this.searchifinvert(node.right, data);
    }
    ...
    // move left
      ...
      traverseTime += 2 * traverseTimeChange;
      return this.searchifinvert(node.left, data);
    }
...
findMin_Button.addEventListener("click", function (e) {
  ...
  if (insertInvert % 2 === 0) {
    BST.findMinNodeifInvert(BST.root);
  } else {
...
search_button.addEventListener("click", function (e) {
  ...
  if (insertInvert % 2 == 0) {
    BST.searchifinvert(BST.root, Number(search_node_Value.value));
  } else {
    BST.search(BST.root, Number(search_node_Value.value));
  }
});
/////////////////////////////////////////////////////////////////////////
